...
#### 📈 [Investment Tracker - 个人投资组合追踪助手](https://github.com/Gip886/investment-tracker)

一个基于 **React** 和 **Ant Design Mobile** 的移动端优先投资组合管理应用，帮助用户轻松记录和分析投资收益。

- **核心亮点**:
  - 💰 **全方位交易记录**: 支持买入、卖出、分红等多种交易类型，自动处理手续费。
  - 📊 **实时持仓分析**: 基于交易流水自动计算持仓成本、持仓数量及实时盈亏。
  - 📱 **移动端适配**: 采用 Ant Design Mobile 组件库，提供优秀的原生级移动端体验。
  - 🔒 **数据本地化**: 使用 Zustand + LocalStorage 实现数据持久化，支持数据导入导出。
- **技术栈**: React 19, TypeScript, Vite, Zustand, Ant Design Mobile, ECharts.
